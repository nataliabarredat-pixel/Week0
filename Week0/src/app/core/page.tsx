  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-8 space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="rounded-2xl border border-stone-250 bg-white p-6 dark:border-stone-850 dark:bg-stone-900 shadow-sm space-y-4">
            ...
            <form onSubmit={handleExtractCore} className="space-y-4">
              ...
              <div>
                <label className="text-[10px] font-bold uppercase tracking-wider text-rose-800 dark:text-rose-450 block mb-2">Priority Focus Elements</label>
              ...
              <div>
                <label className="text-[10px] font-bold uppercase tracking-wider text-rose-800 dark:text-rose-405 block mb-1">Tell Us Your Vibe</label>
                <textarea
                  required
                  rows={3}
          ...
          {activeBlueprint ? (
            <div className="rounded-2xl border border-stone-200 bg-white p-6 dark:border-stone-850 dark:bg-stone-900 shadow-lg space-y-6 animate-fade-in relative overflow-hidden">
              ...
              <div className="flex items-center space-x-1.5 text-xs text-stone-500 font-medium">
                ...
                <span className="font-semibold text-rose-700 dark:text-rose-455">{activeBlueprint.vision_style}</span>
              </div>
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="rounded-2xl border border-stone-255 bg-white p-6 dark:border-stone-855 dark:bg-stone-900 shadow-sm space-y-4">
            <h2 className="font-serif font-bold text-lg text-stone-800 dark:text-stone-100 flex items-center">
              ...
              <div className="space-y-3 max-h-[500px] overflow-y-auto pr-1">
                {blueprints.map(bp => (
                  <div 
                    ...
                    className="p-3.5 rounded-xl border border-stone-200 bg-stone-50/50 hover:bg-rose-500/5 hover:border-rose-300 transition-all cursor-pointer flex items-start justify-between gap-3 dark:border-stone-800 dark:bg-stone-955"
                  >
                    <div className="space-y-1">
